      ...
      return this.each(function() {
          ...
          !function() {
              ...
              c.on("keydown.touchspin", function(t) {
                  ...
                  38 === n ? ("up" !== f && (x(),
                  w()),
                  t.preventDefault()) : 40 === n && ("down" !== f && (g(),
                  m()),
                  t.preventDefault())
              }),
              ...
              c.on("touchspin.destroy", function() {
                  ...
                  c.unwrap()) : (j(".bootstrap-touchspin-injected", t).remove(),
              ...
              c.on("touchspin.updatesettings", function(t, n) {
                  !function(t) {
                      ...
                      h();
                      var n = o.input.val();
                      "" !== n && (n = Number(i.callback_before_calculation(o.input.val())),
